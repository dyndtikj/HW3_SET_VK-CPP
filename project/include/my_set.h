...
template <class Key>
void Set<Key>::erase(const typename Set<Key>::iterator first,
                     const typename Set<Key>::iterator last) {
...
//        way. Managing the pointer is the user's responsibility. ~Set() =
//        default; void clear();
//
//        // 2
//        const_iterator begin() const ;
...
//            const Key& value) {
//        //        bool found(true);
//        //        auto i(lower_bound(static_cast<Key>(value)));
//        //        if(i == end() || compare_(static_cast<Key>(value), *i)) {
//        //            i = rbtree_.insert(i, static_cast<Key>(value));
//        //            found = false;
//        //        }
//        //        return std::make_pair(i, !found);
//        std::pair<typename Tree::iterator, bool> p =
//        rbtree_.InsertUnique(value); return std::pair<iterator, bool>(p.first,
//        p.second);
//    }
//
//    template <class Key>
...
//
//    template <class Key>
//    typename Set<Key>::const_iterator Set<Key>::find(const key_type& value)
//    const {
//        const_iterator i(lower_bound(value));
//        if (i != end() && (value < *i)) {
//            i = end();
