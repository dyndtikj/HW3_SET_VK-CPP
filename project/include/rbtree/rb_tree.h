...
//            delete(n->)
    ...
    template <typename T>
    typename RBTree<T>::node_ptr RBTree<T>::GetRoot() const { return root_; }

    template <typename T>
    typename RBTree<T>::iterator RBTree<T>::Root() { return iterator(root_); }

    template <typename T>
    size_t RBTree<T>::GetSize() const { return size_; }
    ...
    template <typename T>
    typename RBTree<T>::iterator RBTree<T>::MaxIter() { return iterator(MaxNode()); }
    ...
    template <typename T>
    typename RBTree<T>::iterator RBTree<T>::MinIter() { return iterator(MinNode()); }
    ...
    template <typename T>
    RBTree<T>::operator bool() const { return !IsEmpty(); }

    template <typename T>
    typename RBTree<T>::iterator RBTree<T>::begin() const noexcept { return iterator(MinNode()); }
